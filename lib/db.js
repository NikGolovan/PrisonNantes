...
let query1 = `
create table if not exists Detenu(
n_ecrou varchar(10),
prenom varchar(30),
nom varchar(30),
date_naissance Date,
...
create table if not exists Detenu_Affaire(
n_ecrou varchar(10),
n_affaire varchar(10),
nom_juridiction varchar(30),
...
create table if not exists Reduction_peine(
n_type_decision varchar(1),
n_ecrou varchar(10),
date_decision Date,
duree Integer,
...
create table if not exists Liberation_definitive(
n_type_decision varchar(1),
n_ecrou varchar(10),
date_decision Date,
